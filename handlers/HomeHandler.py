...
class GetHomeData(RequestBaseHandler):
    ...
    def post(self, *args, **kwargs):
        ...
        sql = """SELECT user_id, user_name, user_avatar, user_vip_level, \
            ppy_id, ppy_publish_time, ppy_content_text, ppy_content_type, ppy_pic_thumb_urls, ppy_pic_original_urls, ppy_video_cover_url, ppy_video_url, \
        ...
        for result in results:
            ...
            if ppy_content_type == 2 :
                ...
                if not all([ppy_pic_original_urls, ppy_pic_thumb_urls]):
                    continue
